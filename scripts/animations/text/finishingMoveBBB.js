...
/**
 * Creates a Kekkai Sense Style Finishing Move
 *
 * @export
 * @param {String} text Text for move
 * @param {{textColor: String, textBorderColor: String, volume: Number, }} settings
 * @return {*} 
 */
export async function createFinishingMoveBBB(text, settings) {
...
function calculateYPositions(lineCount) {
  switch (lineCount) {
    ...
    default:
      throw new Error(
        "Unsupported number of lines. Only supports up to 4 lines.",
      );
  }
}
